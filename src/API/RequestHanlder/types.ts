...
export type StringKeysOf<O extends {}> = ((k: keyof O) => void) extends (
  k: infer K
) => void
  ? K extends string
    ? K
...
export type GetUndefinedTypes<ALL extends {}, PARSED extends {}> = Omit<
...
export type ValidatorList<K extends {}> = Validator<StringKeysOf<K>>[];

export interface FieldValidators<GD, PD> {
